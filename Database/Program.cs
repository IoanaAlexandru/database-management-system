        ...
        static void Main(string[] args)
        {
            ...
            while (!cmd.Equals("QUIT") && !cmd.Equals("EXIT"))
            {
                ...
                else if (cmd.IndexOf(CMD_SELECT) == 0)
                {
                    ...
                    List<string[]> filtered = Utils.Filter(table, where_cond);
                    var selected = table.Select(ref columns, filtered);
                ...
                else if (cmd.IndexOf(CMD_UPDATE) == 0)
                {
                    ...
                    var filtered = Utils.Filter(table, where_cond);
                    table.Update(names, values, filtered);
                }
